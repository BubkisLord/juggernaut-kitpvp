item replace entity @s hotbar.8 with written_book[written_book_content={title:"Fishmonger",author:"§9Server",pages:[\
[{"text": "Fishmonger\n\n","bold": true,"color": "#2AB8B8","underlined": false},\
 {"text": "A mobile attacker who may launch across the map and throw tridents at runners.","bold": false,"color": "black"}],\
\
[{"text": "One with the Tides\n","bold": true,"color": "#2AB8B8"},{"text": "Passive Effect\n\n","bold": true,"color": "gray","italic": true},{"text": "You take no fall damage.","bold": false,"color": "black"}],\
\
