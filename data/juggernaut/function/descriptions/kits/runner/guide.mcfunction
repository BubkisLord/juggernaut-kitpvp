item replace entity @s hotbar.8 with written_book[written_book_content={title:"Guide",author:"§9Server",pages:[\
[{"text": "Guide\n\n","bold": true,"color": "#FFD700","underlined": false},\
 {"text": "A supportive runner who bolsters teammates in chase and accelerates replenishment.","bold": false,"color": "black"}],\
\
