...
{"text": "§l§4Rapid Brutality\n\n§r§0Gain a 10% speed boost after hitting a runner, lasting for 4 seconds."},\
{"text": "§l§4Brutal Efficiency\n\n§r§0Replenishment station progress regresses by 10% if a runner is hit within 12 blocks of a station. This ability has a cooldown of 15 seconds."},\
...
{"text": "§l§4Insidious\n\n§r§0While invisible, you become undetectable. If not invisible, you cannot be undetectable. This perk is permanently active."}],title:"Juggernaut Perks",generation:0,author:"§9Server"}]