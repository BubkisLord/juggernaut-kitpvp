...
{"text": "§l§4Unwavering Strength\\n\\n§r§0While the juggernaut is close by, this perk activates. While active you may continue replenishing and get +100% replenishment speed."},\
