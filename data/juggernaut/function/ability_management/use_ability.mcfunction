...
# Run the ability
$execute if score #ability_id var matches 1.. as @s at @s run function juggernaut:ability_management/$(player_tag)_ability_$(ability_id)
$execute if score #ability_id var matches 0 as @s at @s run function juggernaut:ability_management/$(player_tag)_ability
