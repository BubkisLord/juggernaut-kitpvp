execute at @n[type=armor_stand,tag=replenishment.station,distance=..3] as @a[tag=runner,distance=..3] run function juggernaut:add_replenishment_percent {percentage:3}
