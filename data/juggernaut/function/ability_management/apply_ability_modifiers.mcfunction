...
execute as @s[scores={ability_buff=1..,ticks_spent_on_ability_buff=0}] run scoreboard players remove @s ability_cooldown0 1
...
execute as @s[scores={ability_debuff=1..,ticks_spent_on_ability_debuff=0}] run scoreboard players add @s ability_cooldown0 1