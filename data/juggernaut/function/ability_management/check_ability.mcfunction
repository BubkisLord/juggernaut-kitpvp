$execute as @s[nbt={Inventory:[{id:"minecraft:iron_nugget"}]}] if items entity @s inventory.* minecraft:iron_nugget run clear @s minecraft:iron_nugget[item_name=[$(item_name),{"text": " | ","color": "dark_gray","bold": true},{"text": "READY","color": "green","bold": true}],custom_data={kit:$(player_tag),ability_id:"$(ability_id)"}]
$execute as @s[nbt={Inventory:[{id:"minecraft:iron_nugget"}]}] if items entity @s player.cursor minecraft:iron_nugget run clear @s minecraft:iron_nugget[item_name=[$(item_name),{"text": " | ","color": "dark_gray","bold": true},{"text": "READY","color": "green","bold": true}],custom_data={kit:$(player_tag),ability_id:"$(ability_id)"}]
$execute as @s[nbt={Inventory:[{id:"minecraft:iron_nugget"}]}] if items entity @s weapon.offhand minecraft:iron_nugget run clear @s minecraft:iron_nugget[item_name=[$(item_name),{"text": " | ","color": "dark_gray","bold": true},{"text": "READY","color": "green","bold": true}],custom_data={kit:$(player_tag),ability_id:"$(ability_id)"}]
...
$execute as @s[tag=!spectator] if score @s $(cooldown_var) matches 0 run item replace entity @s $(hotbar_slot) with minecraft:iron_nugget[item_name=[$(item_name),{"text": " | ","color": "dark_gray","bold": true},{"text": "READY","color": "green","bold": true}],custom_data={kit:$(player_tag),ability_id:"$(ability_id)"},item_model="$(item_model)",consumable={consume_seconds:0,animation:"none",has_consume_particles:false,sound:{"sound_id":""}},lore=$(description)]
...
$execute as @s[tag=!spectator] if score @s $(cooldown_var) matches 1.. run clear @s minecraft:iron_nugget[item_name=[$(item_name),{"text": " | ","color": "dark_gray","bold": true},{"text": "READY","color": "green","bold": true}],custom_data={kit:$(player_tag),ability_id:"$(ability_id)"}]
xp set @a 240 levels
