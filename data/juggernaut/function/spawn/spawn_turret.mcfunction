...
summon skeleton ~ ~ ~ {Team:"runner",HandItems:[{"id":"bow",components:{enchantments:{power:8,flame:2}}},{}],HandDropChances:[0,0],ActiveEffects:[{Id:12,Duration:9999999,Amplifier:0,ShowParticles:false}],DeathLootTable:"empty",Attributes:[{id:"generic.max_health",base:30}],Tags:["kill_on_end_game","skeleton_turret"],Invulnerable:true}
