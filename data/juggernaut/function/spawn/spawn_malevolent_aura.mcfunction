execute at @a[tag=warlock] run summon armor_stand ~ ~0.5 ~ {NoGravity:true,Invulnerable:true,Invisible:true,CustomName:{"text": "Malevolent Aura","color": "dark_red","bold": true},CustomNameVisible:true,Tags:["malevolent_aura","warlock_armor_stand"]}
