...
summon armor_stand ~ ~0.5 ~ {Invisible:true,Invulnerable:true,CustomName:'{"text": "Revealing Tower","bold": true,"color": "gold"}',CustomNameVisible:true,NoGravity:true,Small:true,Tags:["revealing_tower","engineer_tower","kill_on_end_game"]}
# Duration
