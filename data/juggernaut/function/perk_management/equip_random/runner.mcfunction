...
execute if score #roll var matches 15 if entity @s[tag=using_overclock] run function juggernaut:perk_management/equip_random/runner
execute if score #roll var matches 15 unless entity @s[tag=using_overclock] run function juggernaut:perk_management/add_perk/runner {perk_id:"overclock",perk_name:"Overclock"}

execute if score #roll var matches 16 if entity @s[tag=using_optimised] run function juggernaut:perk_management/equip_random/runner
execute if score #roll var matches 16 unless entity @s[tag=using_optimised] run function juggernaut:perk_management/add_perk/runner {perk_id:"optimised",perk_name:"Optimised"}

execute if score #roll var matches 17 if entity @s[tag=using_any_means] run function juggernaut:perk_management/equip_random/runner
execute if score #roll var matches 17 unless entity @s[tag=using_any_means] run function juggernaut:perk_management/add_perk/runner {perk_id:"any_means",perk_name:"Any Means Necessary"}

execute if score #roll var matches 18 if entity @s[tag=using_forewarned] run function juggernaut:perk_management/equip_random/runner
execute if score #roll var matches 18 unless entity @s[tag=using_forewarned] run function juggernaut:perk_management/add_perk/runner {perk_id:"forewarned",perk_name:"Forewarned"}
