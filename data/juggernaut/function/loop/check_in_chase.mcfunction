...
execute as @a[tag=juggernaut,predicate=!is_sneaking,tag=!shapeshifting] at @s anchored eyes positioned ^ ^ ^10 if entity @a[tag=runner,distance=..14,tag=!has_respawn_protection,predicate=!is_sneaking,predicate=!is_sprinting] run tag @s add chase_eligible
execute as @a[tag=juggernaut,predicate=!is_sneaking,tag=!shapeshifting] at @s anchored eyes positioned ^ ^ ^10 as @a[tag=runner,distance=..14,tag=!has_respawn_protection,predicate=!is_sneaking,predicate=!is_sprinting] run tag @s add chase_eligible
