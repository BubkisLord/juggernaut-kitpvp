...
execute as @a[tag=knight] at @s if entity @e[type=area_effect_cloud,tag=knight_marker,distance=10..] run scoreboard players set @s ability_cooldown0 14000
...
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 12001..14000 unless items entity @s container.* wooden_spear run clear @s #spears
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 12001..14000 unless items entity @s container.* wooden_spear run item replace entity @s hotbar.1 with minecraft:wooden_spear[item_name={"text": "Knight's Lance", "color": "yellow"},unbreakable={},tooltip_display={hidden_components:["unbreakable","enchantments"]}]
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 8001..12000 unless items entity @s container.* stone_spear run clear @s #spears
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 8001..12000 unless items entity @s container.* stone_spear run item replace entity @s hotbar.1 with minecraft:stone_spear[item_name={"text": "Knight's Lance", "color": "yellow"},enchantments={lunge:1},unbreakable={},attribute_modifiers=[{type:"attack_damage",id:"attack_damage",amount:-100,operation:"add_multiplied_total",slot:"mainhand"}],tooltip_display={hidden_components:["unbreakable","enchantments"]}]
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 4001..8000 unless items entity @s container.* iron_spear run clear @s #spears
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 4001..8000 unless items entity @s container.* iron_spear run item replace entity @s hotbar.1 with minecraft:iron_spear[item_name={"text": "Knight's Lance", "color": "yellow"},enchantments={lunge:1},unbreakable={},attribute_modifiers=[{type:"attack_damage",id:"attack_damage",amount:-100,operation:"add_multiplied_total",slot:"mainhand"}],tooltip_display={hidden_components:["unbreakable","enchantments"]}]
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 1..4000 unless items entity @s container.* golden_spear run clear @s #spears
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 1..4000 unless items entity @s container.* golden_spear run item replace entity @s hotbar.1 with minecraft:golden_spear[item_name={"text": "Knight's Lance", "color": "yellow"},enchantments={lunge:2},unbreakable={},attribute_modifiers=[{type:"attack_damage",id:"attack_damage",amount:-100,operation:"add_multiplied_total",slot:"mainhand"}],tooltip_display={hidden_components:["unbreakable","enchantments"]}]
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 0 unless items entity @s container.* diamond_spear run clear @s #spears
execute as @a[tag=knight] at @s if score @s ability_cooldown0 matches 0 unless items entity @s container.* diamond_spear run item replace entity @s hotbar.1 with minecraft:diamond_spear[item_name={"text": "Knight's Lance", "color": "yellow"},enchantments={lunge:2},unbreakable={},attribute_modifiers=[{type:"attack_damage",id:"attack_damage",amount:-100,operation:"add_multiplied_total",slot:"mainhand"}],tooltip_display={hidden_components:["unbreakable","enchantments"]}]
