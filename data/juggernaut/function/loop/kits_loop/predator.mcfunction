...
execute if entity @s[predicate=is_invisible] run attribute @s movement_speed modifier add juggernaut:predator_move_spd 0.15 add_multiplied_base
...
function juggernaut:ability_management/check_ability {\
    player_tag:"predator",\
    item_id:"minecraft:blaze_powder",\
