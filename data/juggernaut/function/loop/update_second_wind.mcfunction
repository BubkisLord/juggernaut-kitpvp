execute unless entity @s[scores={used_totem=1..}] if entity @s[scores={lives_remaining=..1}] unless items entity @s container.* totem_of_undying run give @s totem_of_undying[item_name={"text":"Second Wind"}]
