...
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if score #game_state var matches 11 if score @s withering_surge_cooldown = #0 var run item replace entity @a[tag=warlock] hotbar.3 with black_dye[item_name='[{"text": "Spawn Withering Surge","color": "black","bold": true},{"text": " | "},{"text": "READY","color": "green"}]']
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if score #game_state var matches 11 if score @s withering_surge_cooldown > #0 var run item replace entity @a[tag=warlock] hotbar.3 with barrier[item_name='[{"text": "Spawn Withering Surge","color": "black","bold": true},{"text": " | "},{"text": "ON COOLDOWN","color": "red"}]']
