...
execute if score #game_state var matches 10..19 unless entity @a[tag=juggernaut] run function stats:reward_runner_win
...
execute if score #game_state var matches 10..19 unless entity @a[tag=runner] run function stats:reward_jug_win
...
execute if score #juggernaut_customisation completable_stations matches 0 if score #game_state var matches 10..19 if score #juggernaut_manager replenish_progress >= #juggernaut_manager total_replenishment_needed run function stats:reward_runner_win
