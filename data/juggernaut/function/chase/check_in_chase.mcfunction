...
execute as @a[tag=juggernaut,tag=!shapeshifting] at @s if entity @a[tag=runner,distance=..10,scores={is_sneaking=0},tag=using_determination] run tag @s add continue_chase
execute as @a[tag=juggernaut,tag=!shapeshifting] at @s as @a[tag=runner,distance=..10,scores={is_sneaking=0},tag=using_determination] run tag @s add continue_chase
