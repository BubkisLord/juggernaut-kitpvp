...
execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^3 if entity @a[tag=runner,distance=..10,scores={is_sneaking=1}] run scoreboard players set @s chase_timeout 60
execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^3 as @a[tag=runner,distance=..10,scores={is_sneaking=1}] run scoreboard players set @s chase_timeout 60

execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^4 if entity @a[tag=runner,distance=..20,scores={is_sneaking=0}] run scoreboard players set @s chase_timeout 60
execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^4 as @a[tag=runner,distance=..20,scores={is_sneaking=0}] run scoreboard players set @s chase_timeout 60

execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^5 if entity @a[tag=runner,distance=..30,scores={is_sprinting=1}] run scoreboard players set @s chase_timeout 60
execute as @a[tag=juggernaut,scores={is_sneaking=0}] at @s positioned ^ ^ ^5 as @a[tag=runner,distance=..30,scores={is_sprinting=1}] run scoreboard players set @s chase_timeout 60
