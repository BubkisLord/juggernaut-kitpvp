...
give @s diamond_sword[tooltip_display={hidden_components:["enchantments","unbreakable"]},unbreakable={},item_model="blaze_rod",item_name=[{"text": "Warlock's Scepter","bold":false,"color":"gold"},{"text": " | ","color": "dark_gray","bold": true},{"text": "MELEE WEAPON","color": "gray","bold": true}]]
