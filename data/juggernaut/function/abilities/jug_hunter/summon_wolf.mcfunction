...
execute unless entity @a[tag=hunted] as @a[tag=jug_hunter] at @s run particle angry_villager ~ ~0.5 ~ 1 1 1 0 80 force
execute unless entity @a[tag=hunted] run scoreboard players set @s jug_kit_cooldown_2 4
