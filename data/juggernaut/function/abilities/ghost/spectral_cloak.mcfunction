function juggernaut:effects/apply_effect {effect:"not_replenishing",duration:5,color:"gray"}
function juggernaut:effects/apply_effect {effect:"undetectable",duration:5,color:"gray"}
