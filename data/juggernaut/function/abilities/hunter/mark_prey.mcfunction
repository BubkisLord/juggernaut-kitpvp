...
execute if score #game_state var matches 10..19 unless entity @a[tag=runner,distance=..12] run scoreboard players set @s ability_cooldown0 8
...
execute if score #game_state var matches 40..49 unless entity @a[distance=0.5..12] run scoreboard players set @s ability_cooldown0 8
