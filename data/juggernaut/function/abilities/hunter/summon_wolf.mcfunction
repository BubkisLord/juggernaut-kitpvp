...
summon minecraft:wolf ~ ~ ~ {CustomName:{"text":"Bloodhound"},CustomNameVisible:true,attributes:[{id:"max_health",base:45},{id:"movement_speed",base:0.5},{id:"follow_range",base:999},{id:"attack_damage",base:1},{id:"scale",base:1.5}],PersistenceRequired:1b,Tags:["hunter_wolf","kill_on_end_game"],Team:"jug"}
