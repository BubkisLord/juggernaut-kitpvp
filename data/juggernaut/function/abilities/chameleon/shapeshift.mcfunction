...
summon text_display ~ ~2 ~ {default_background:true,width:2,Tags:["chameleon_health_tag","kill_on_end_game"],teleport_duration:3,text:[{"score":{name:"@p[tag=saved_skin]",objective:"health"},color:"green"},{"text":" Health","color": "green"}],billboard:"center",view_range:10}
