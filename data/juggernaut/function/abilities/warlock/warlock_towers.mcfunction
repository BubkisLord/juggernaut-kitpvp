...
bossbar set warlock:revealing_tower max 100
...
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] store result bossbar warlock:revealing_tower value run scoreboard players get @s temp_progress
...
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] at @s run bossbar set warlock:revealing_tower visible true
...
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] at @s run tag @a[distance=..16] add see_revealing_tower_bar
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] at @s run tag @a[tag=warlock] add see_revealing_tower_bar
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] at @s run tag @a[distance=17..,tag=!warlock] remove see_revealing_tower_bar
execute unless entity @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] run tag @a remove see_revealing_tower_bar
...
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=warlock_revealing_tower] at @s run bossbar set warlock:revealing_tower players @a[tag=see_revealing_tower_bar]
...
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=malevolent_aura] at @s run execute if score @s dispel_progress >= @s total_dispelling_needed as @p[tag=juggernaut,tag=warlock] run scoreboard players set @s ability_cooldown0 20000
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=banishment_glyph] at @s run execute if score @s dispel_progress >= @s total_dispelling_needed as @p[tag=juggernaut,tag=warlock] run scoreboard players set @s ability_cooldown1 30000
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=withering_surge] at @s run execute if score @s dispel_progress >= @s total_dispelling_needed as @p[tag=juggernaut,tag=warlock] run scoreboard players set @s ability_cooldown2 40000
execute as @e[type=armor_stand,tag=warlock_armor_stand,tag=revealing_tower] at @s run execute if score @s dispel_progress >= @s total_dispelling_needed as @p[tag=juggernaut,tag=warlock] run scoreboard players set @s ability_cooldown3 35000
