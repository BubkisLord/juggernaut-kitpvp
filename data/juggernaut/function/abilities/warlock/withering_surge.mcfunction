...
execute at @p[tag=warlock] run summon armor_stand ~ ~1 ~ {NoGravity:false,Invulnerable:true,Invisible:true,CustomName:{"text": "Withering Surge","color": "dark_gray","bold": true},Marker:false,CustomNameVisible:true,Tags:["withering_surge","warlock_armor_stand"]}
