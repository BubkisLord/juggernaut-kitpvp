...
execute as @a[tag=medic,tag=teleporting] if entity @a[tag=runner,tag=!teleporting] if entity @a[tag=runner,tag=in_chase] run tp @s @p[tag=runner,tag=!teleporting,tag=in_chase]
execute as @a[tag=medic,tag=teleporting] if entity @a[tag=runner,tag=!teleporting] unless entity @a[tag=runner,tag=in_chase] run tp @s @r[tag=runner,tag=!teleporting]
