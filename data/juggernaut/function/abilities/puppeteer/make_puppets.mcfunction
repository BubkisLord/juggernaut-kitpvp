...
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s0","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s1","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s2","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s3","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s4","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
summon mannequin ~ ~ ~ {Tags:["puppeteer_puppet","puppet_s5","kill_on_end_game","pp_new_puppet"],NoGravity:1b,pose:"standing",Health:1f}
