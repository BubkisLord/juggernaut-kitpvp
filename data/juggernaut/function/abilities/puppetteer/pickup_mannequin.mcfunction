# Run as the puppetteer at the puppetteer. Picks the mannequin back up if within 3 blocks.
...
# Pick it up: removing the mannequin here (before the death-link check) does NOT kill the puppetteer.
