# Run as the puppetteer, positioned at the puppetteer. Summons the linked mannequin.
...
summon mannequin ~ ~ ~ {Tags:["puppetteer_mannequin","kill_on_end_game","pp_new_mannequin"],pose:"standing",Health:200f,attributes:[{id:"max_health",base:200}],Rotation:[0f,0f]}
...
# Make the mannequin wear the puppetteer's skin and link it to this owner.
