# Run as the puppetteer at the puppetteer. Keeps this owner's ring of puppets locked in formation
...
tag @e[type=mannequin,tag=puppetteer_puppet] remove pp_owned
execute as @e[type=mannequin,tag=puppetteer_puppet] if score @s puppet_id = #pp_link var run tag @s add pp_owned

# If the centre is somehow missing, end the ability cleanly.
execute unless entity @e[type=marker,tag=pp_c] run function juggernaut:abilities/puppetteer/end_puppets
...
execute if score @s pp_slot matches 0 run function juggernaut:abilities/puppetteer/move_center {nx:"-2.0",nz:"0.0"}
execute if score @s pp_slot matches 1 run function juggernaut:abilities/puppetteer/move_center {nx:"-1.0",nz:"-1.732"}
execute if score @s pp_slot matches 2 run function juggernaut:abilities/puppetteer/move_center {nx:"1.0",nz:"-1.732"}
execute if score @s pp_slot matches 3 run function juggernaut:abilities/puppetteer/move_center {nx:"2.0",nz:"0.0"}
execute if score @s pp_slot matches 4 run function juggernaut:abilities/puppetteer/move_center {nx:"1.0",nz:"1.732"}
execute if score @s pp_slot matches 5 run function juggernaut:abilities/puppetteer/move_center {nx:"-1.0",nz:"1.732"}
