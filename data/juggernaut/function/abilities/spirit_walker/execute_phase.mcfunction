...
execute if entity @s[tag=teleporting] as @n[type=mannequin,tag=phase_shift_destination] at @s if block ~ ~0.5 ~ #juggernaut:raycast_permeable run scoreboard players set @p[tag=teleporting] jug_kit_cooldown 10
