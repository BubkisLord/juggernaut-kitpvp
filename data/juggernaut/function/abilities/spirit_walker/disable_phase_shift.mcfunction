execute as @a[tag=spirit_walker] run attribute @s generic.step_height base set 0.6
execute as @a[tag=spirit_walker] run attribute @s generic.jump_strength base set 0.4199999
