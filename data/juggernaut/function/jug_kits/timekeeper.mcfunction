...
give @s golden_sword[item_name={"text": "Golden Scimitar"},enchantments={sharpness:3},lore=[{"text":"Why a scimitar?","color":"dark_gray"},{"text":"Who's to say! (But he's not here so I guess we'll never know...)","color":"dark_gray"}],unbreakable={}]
