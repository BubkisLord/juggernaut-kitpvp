...
give @s diamond_sword[enchantments={sharpness:2},tooltip_display={hidden_components:["enchantments","unbreakable"]},unbreakable={},item_model="blaze_rod",item_name={"text":"Warlock's Scepter",color:"gold"}]
