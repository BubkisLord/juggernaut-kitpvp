...
give @s blackstone[attribute_modifiers=[{type:"minecraft:attack_damage",id:"minecraft:attack_damage",amount:6.5,operation:"add_value"}],tooltip_display={hidden_components:["attribute_modifiers"]},item_name=[{"text": "Sharp Rock","bold":false,"color":"dark_purple"},{"text": " | ","color": "dark_gray","bold": true},{"text": "MELEE WEAPON","color": "gray","bold": true}]]
tellraw @a[tag=juggernaut] [{"selector":"@s"},{"text":": ","color":"red"},{"text": "Selected ","color":"white"},{"text":"Witch Doctor","color":"dark_purple"},{"text":" Kit.","color":"white"}]
