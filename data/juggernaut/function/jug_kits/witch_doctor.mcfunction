...
execute as @s[tag=!has_jug_kit] run give @s blackstone[attribute_modifiers={modifiers:[{type:"minecraft:attack_damage",id:"minecraft:attack_damage",amount:6.5,operation:"add_value"}]}]
