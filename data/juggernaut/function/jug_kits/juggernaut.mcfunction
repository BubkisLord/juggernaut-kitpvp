...
execute as @s[tag=!has_jug_kit] run give @s netherite_axe[attribute_modifiers=[{type:"attack_speed",id:"attack_speed",amount:-3.5,operation:"add_value"}, {type:"attack_damage",id:"attack_damage",amount:14,operation:"add_value"}],item_name={"text": "Dooming Axe","color": "dark_purple"},lore=[{"text": "Most lovingly called by its owners as the following:","color": "dark_gray"},{"text": "Non-Vehicular 'Manslaughter'","color": "dark_gray"},{"text": "WidowMaker","color": "dark_gray"},{"text": "Scourge of Utter Doom","color": "dark_gray"},{"text": "Executioner of the Might of Lord Duke Hotenow XII","color": "dark_gray"},{"text": "Taker of Names","color": "dark_gray"},{"text": "Hades' Employee of the Month #203","color": "dark_gray"},{"text": "Stealer of Lives","color": "dark_gray"},{"text": "Murderer of Cows, (Pea-)Fowls, and All Manner of Cowls (not fashionable!)","color": "dark_gray"}]]
execute as @s[tag=!has_jug_kit] run give @s golden_apple 2
execute as @s[tag=!has_jug_kit] run function juggernaut:descriptions/kits/juggernaut/juggernaut
execute as @s[tag=!has_jug_kit] run tag @s add classic_jug
