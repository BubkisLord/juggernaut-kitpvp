...
item replace entity @s hotbar.0 with diamond_sword[unbreakable={},enchantments={sharpness:2},tooltip_display={hidden_components:["enchantments","unbreakable"]},item_name={text:"Veil Slicer","color":"#577ebe"}]
