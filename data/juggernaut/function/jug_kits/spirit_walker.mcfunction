...
attribute @s movement_speed modifier add juggernaut:spirit_walker -0.15 add_multiplied_base
attribute @s fall_damage_multiplier modifier add juggernaut:spirit_walker -0.6 add_multiplied_base
