...
give @s diamond_sword[enchantments={sharpness:3},unbreakable={},item_name=[{"text": "Predator's Blade","color":"#b5ee4a"},{"text": " | ","color": "dark_gray","bold": true},{"text": "MELEE WEAPON","color": "gray","bold": true}]]
