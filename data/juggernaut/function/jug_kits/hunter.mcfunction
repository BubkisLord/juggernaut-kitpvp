...
give @s bow[enchantments={infinity:1},tooltip_display={hidden_components:["unbreakable","enchantments"]},item_name={"text": "Hunter's Bow","color": "dark_red"},enchantment_glint_override=true,unbreakable={}]
