...
give @s iron_sword[item_name=[{"text": "Machete","bold":false,"color":"dark_red"},{"text": " | ","color": "dark_gray","bold": true},{"text": "MELEE WEAPON","color": "gray","bold": true}],enchantments={sharpness:1},unbreakable={},tooltip_display={hidden_components:["unbreakable","enchantments"]}]
