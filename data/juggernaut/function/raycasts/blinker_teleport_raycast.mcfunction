...
execute as @n[tag=blinker_raycast_tracker] at @s anchored eyes positioned ^ ^ ^0.5 if entity @e[distance=..5,tag=blinker_remnant] as @e[distance=..1,tag=blinker_remnant] at @s run particle dust{color:233333,scale:2} ~ ~0.5 ~ 0.5 2 0.5 0.4 4 force @a
