...
execute if score @n[type=armor_stand,tag=portal_tether_3] current_raycast_depth <= @n[type=armor_stand,tag=portal_tether_3] raycast_limit as @n[tag=chain_raycast_tracker_3] at @s anchored eyes positioned ^ ^ ^0.5 if block ~ ~ ~ air unless entity @n[tag=runner,distance=..1.5] run function juggernaut:raycasts/chain_raycast3
execute if score @n[type=armor_stand,tag=portal_tether_3] current_raycast_depth <= @n[type=armor_stand,tag=portal_tether_3] raycast_limit as @n[tag=chain_raycast_tracker_3] at @s anchored eyes positioned ^ ^ ^0.5 if block ~ ~ ~ water unless entity @n[tag=runner,distance=..1.5] run function juggernaut:raycasts/chain_raycast3
