...
execute if score #hit_function_id var matches 6 run execute as @s at @s positioned ^ ^1 ^-1 run summon armor_stand ~ ~ ~ {Tags:["camera","kill_on_end_game"],Invisible:true,Invulnerable:true,NoGravity:true}
