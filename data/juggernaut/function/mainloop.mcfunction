...
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] as @n[type=armor_stand,tag=runner_kit_selection_room] at @s run particle campfire_cosy_smoke ~ ~1 ~ 7 1 7 0.00001 1 force
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] as @n[type=armor_stand,tag=runner_kit_selection_room] at @s run effect give @a[distance=..30] weakness 1 255 true

execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] as @n[type=armor_stand,tag=runner_kit_selection_room] at @s run tp @a[tag=has_jug_kit,tag=runner,distance=..20] @e[tag=arena.spawn,limit=1,sort=random]
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] as @n[type=armor_stand,tag=runner_kit_selection_room] at @s run tag @a[distance=..10] remove lobby.player
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] as @n[type=armor_stand,tag=runner_kit_selection_room] at @s run clear @a[tag=!has_jug_kit,distance=..10]

execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] as @n[type=armor_stand,tag=juggernaut_kit_selection_room] at @s run particle ash ~ ~1 ~ 7 1 7 0.00001 5 force
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] as @n[type=armor_stand,tag=juggernaut_kit_selection_room] at @s run particle white_ash ~ ~1 ~ 7 1 7 0.00001 5 force
execute if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] as @n[type=armor_stand,tag=juggernaut_kit_selection_room] at @s run particle crimson_spore ~ ~1 ~ 7 1 7 0.00001 5 force

execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] as @n[type=armor_stand,tag=juggernaut_kit_selection_room] at @s run effect give @a[distance=..30] weakness 1 255 true

execute unless entity @a[tag=!has_jug_kit] if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] run function juggernaut:start_juggernaut

# If there are no runners or juggernauts then the game will end.
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run tellraw @a {"text": "Runners win! (Juggernaut Dead/Not Found)","bold": true}
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run scoreboard players add @a[tag=runner] points 100
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run function juggernaut:end_game

execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run tellraw @a {"text": "Juggernaut wins! (Runners Dead/Not Found)","bold": true}
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run scoreboard players add @a[tag=juggernaut] points 100
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run function juggernaut:end_game

#The replenish progress mode for winning the game. (3 mins of continued replenishing)
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if score @n[type=armor_stand,tag=juggernaut_manager] replenish_progress >= @n[type=armor_stand,tag=juggernaut_manager] total_replenishment_needed run tellraw @a {"text": "Runners win! (Replenishment Complete)","bold": true}
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run scoreboard players add @a[tag=runner] points 100
execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if score @n[type=armor_stand,tag=juggernaut_manager] replenish_progress >= @n[type=armor_stand,tag=juggernaut_manager] total_replenishment_needed run function juggernaut:end_game

# If the 5 minutes runs out, then the game ends.
# execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if entity @a[tag=juggernaut,scores={juggernaut_game_time=0}] run scoreboard players add @a[tag=runner] kills 5
# execute unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if entity @a[tag=juggernaut,scores={juggernaut_game_time=0}] run function juggernaut:end_game



#Code to calculate the percentage of replenishment progress and display it...
#...never look through this code again.
scoreboard players operation @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] temp_progress = @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_progress
scoreboard players operation @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] temp_progress *= #100 var

scoreboard players operation @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] temp_max_progress = @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] total_replenishment_needed
scoreboard players operation @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] temp_max_progress *= #100 var

execute store result score @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_decimal run scoreboard players operation @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] temp_progress /= @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] total_replenishment_needed

execute if score @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_decimal <= #33 var if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run title @a actionbar [{"text":"Replenishment Percentage: ","color": "dark_green","bold": true},{"score":{"name":"@n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}]","objective":"replenish_decimal"},"bold": true,"color": "dark_green"},{"text": "%"}]

execute if score @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_decimal > #33 var if score @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_decimal <= #75 var if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run title @a actionbar [{"text":"Replenishment Percentage: ","color": "gold","bold": true},{"score":{"name":"@n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}]","objective":"replenish_decimal"},"bold": true,"color": "gold"},{"text": "%"}]

execute if score @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] replenish_decimal > #75 var if entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run title @a actionbar [{"text":"Replenishment Percentage: ","color": "dark_red","bold": true},{"score":{"name":"@n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}]","objective":"replenish_decimal"},"bold": true,"color": "dark_red"},{"text": "%"}]


#Jug Kits
# Thrust Ability - Unknown Kit
execute as @a[tag=test_kit] anchored eyes at @s if entity @e[type=item,nbt={Item:{id:"minecraft:white_concrete"}},distance=..3] run tag @s add teleporting
execute as @a[tag=test_kit,tag=teleporting] anchored eyes at @s run tp @s ^ ^ ^5
execute as @a[tag=test_kit,tag=teleporting] anchored eyes at @s run execute as @a[tag=runner,distance=..2] run effect give @s slowness 5 255 true
execute as @a[tag=test_kit,tag=teleporting] at @s run scoreboard players add @s tick_counter 1
execute as @a[tag=test_kit,tag=teleporting] at @s as @n[type=item,nbt={Item:{id:"minecraft:white_concrete"}}] run kill @s
execute as @a[tag=test_kit,tag=teleporting] run tag @s remove teleporting
execute as @a[tag=test_kit,scores={tick_counter=1..}] run scoreboard players add @s tick_counter 1
execute as @a[tag=test_kit,scores={tick_counter=20..}] anchored eyes at @s run tp @s ^ ^ ^8
execute as @a[tag=test_kit,scores={tick_counter=20..}] anchored eyes at @s run execute as @a[tag=runner,distance=..2] run effect give @s slowness 5 255 true
execute as @a[tag=test_kit,scores={tick_counter=20..}] run scoreboard players set @s tick_counter 0
...
# Chain Functionality
execute as @e[tag=possible,nbt={HurtTime:10s}] at @s run summon armor_stand ~ ~2 ~ {Tags:["portal_tether_1","kill_on_end_game","portal_tether"],Invisible:true,Invulnerable:true,CustomNameVisible:false,NoGravity:true,Small:true}
tag @e remove possible
execute as @e[type=minecraft:arrow,nbt={inGround:0b}] at @s run tag @e[distance=..4] add possible

execute as @a[tag=portal_tether] at @s run particle dust{color:[0,0,5],scale:4} ~ ~ ~ 0.5 0.5 0.5 0.4 8 force

execute as @e[type=armor_stand,tag=portal_tether] at @s run scoreboard players set @s current_raycast_depth 0
execute as @e[type=armor_stand,tag=portal_tether] at @s run scoreboard players set @s raycast_limit 30
execute as @e[type=armor_stand,tag=portal_tether,scores={var=10..}] at @s run kill @s
execute as @e[type=armor_stand,tag=portal_tether_1] at @s run function juggernaut:chain_raycast1
execute as @e[type=armor_stand,tag=portal_tether_2] at @s run function juggernaut:chain_raycast2
execute as @e[type=armor_stand,tag=portal_tether_3] at @s run function juggernaut:chain_raycast3


# jug_hunter functionality
execute at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] run tag @p[tag=runner,distance=..12] add has_hunters_mark
# If successful
execute if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] as @a[tag=jug_hunter] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @p[tag=runner,distance=..12,tag=has_hunters_mark] run item replace entity @s hotbar.2 with minecraft:barrier[item_name='[{"text": "Pursue Prey | ","color": "dark_red"},{"text": "ON COOLDOWN","color": "red"}]']
execute if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] as @a[tag=jug_hunter] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @p[tag=runner,distance=..12,tag=has_hunters_mark] run scoreboard players set @s jug_kit_cooldown 40
execute if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @p[tag=runner,distance=..12,tag=has_hunters_mark] run kill @s
# If failure
...
execute if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] unless entity @p[tag=runner,distance=..12,tag=has_hunters_mark] run kill @s
...
execute at @a[tag=predator] as @a[tag=runner,distance=..6] if score @e[type=armor_stand,tag=juggernaut_manager,limit=1] game_state = #1 var run effect give @s darkness 4 0 true
# execute at @a[tag=predator] as @a[tag=runner,distance=..4] if score @e[type=armor_stand,tag=juggernaut_manager,limit=1] game_state = #1 var run effect give @s blindness 4 3 true

# Warlock Functionality
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s malevolent_aura_cooldown = #0 var run item replace entity @a[tag=warlock] hotbar.1 with red_dye[item_name='[{"text": "Spawn Malevolent Aura","color": "dark_red"},{"text": " | "},{"text": "READY","color": "green"}]']
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s malevolent_aura_cooldown > #0 var run item replace entity @a[tag=warlock] hotbar.1 with barrier[item_name='[{"text": "Spawn Malevolent Aura","color": "dark_red"},{"text": " | "},{"text": "ON COOLDOWN","color": "red"}]']

execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s banishment_glyph_cooldown = #0 var run item replace entity @a[tag=warlock] hotbar.2 with cyan_dye[item_name='[{"text": "Spawn Banishment Glyph","color": "dark_blue"},{"text": " | "},{"text": "READY","color": "green"}]']
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s banishment_glyph_cooldown > #0 var run item replace entity @a[tag=warlock] hotbar.2 with barrier[item_name='[{"text": "Spawn Banishment Glyph","color": "dark_blue"},{"text": " | "},{"text": "ON COOLDOWN","color": "red"}]']

execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s withering_surge_cooldown = #0 var run item replace entity @a[tag=warlock] hotbar.3 with black_dye[item_name='[{"text": "Spawn Withering Surge","color": "black"},{"text": " | "},{"text": "READY","color": "green"}]']
execute as @e[type=armor_stand,tag=juggernaut_manager] run execute if entity @s[scores={game_state=1}] if score @s withering_surge_cooldown > #0 var run item replace entity @a[tag=warlock] hotbar.3 with barrier[item_name='[{"text": "Spawn Withering Surge","color": "black"},{"text": " | "},{"text": "ON COOLDOWN","color": "red"}]']
...
execute as @a[tag=survivor] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:stone"}},distance=..3] run effect give @s resistance 3 255 true
