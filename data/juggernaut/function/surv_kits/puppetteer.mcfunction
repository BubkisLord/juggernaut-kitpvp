...
function juggernaut:descriptions/kits/runner/puppetteer
tag @s add puppetteer
tag @s add has_jug_kit
# Assign a unique owner id used to link this puppetteer to their mannequin and puppets.
