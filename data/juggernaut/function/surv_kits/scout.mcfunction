execute as @s[tag=!has_jug_kit] run give @s spyglass[enchantments={knockback:2},enchantment_glint_override=false,tooltip_display={hidden_components:["enchantments"]}]
