...
execute as @s[tag=!has_jug_kit] run give @s iron_sword[custom_model_data=2,item_name='{"text": "Iron Spear"}']
execute as @s[tag=!has_jug_kit] run give @s bow[enchantments={power:1,flame:1,infinity:1},hide_additional_tooltip={},item_name='{"text": "Hunter\'s Bow","color": "dark_red"}',enchantment_glint_override=true,lore=['{"text": "Weapon crafted from the bones of the hunter\'s victims.","color": "dark_gray"}'],unbreakable={},custom_model_data=1]
