...
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run tellraw @a {"text": "Runners win! (Juggernaut Dead/Not Found)","bold": true}
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run scoreboard players add @a[tag=runner] points 100
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=juggernaut] run function juggernaut:end_game

execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run tellraw @a {"text": "Juggernaut wins! (Runners Dead/Not Found)","bold": true}
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run scoreboard players add @a[tag=juggernaut] points 100
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @a[tag=runner] run function juggernaut:end_game
...
#Jug Kits
# Blinker
execute as @a[tag=blinker] run scoreboard players set @s current_raycast_depth 0
execute as @a[tag=blinker] run scoreboard players set @s raycast_limit 30
...
execute at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run tag @p[tag=runner,distance=..12] add has_hunters_mark
...
# If in pregame
execute as @a[tag=jug_hunter] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] run scoreboard players set @s jug_kit_cooldown 8
execute as @a[tag=jug_hunter] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] run item replace entity @s hotbar.2 with minecraft:barrier[item_name='[{"text": "Mark Prey | ","color": "dark_red"},{"text": "ON COOLDOWN","color": "red"}]']
execute at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] run particle angry_villager ~ ~0.5 ~ 1 1 1 0 80 force
execute at @a[tag=jug_hunter] as @e[type=item,nbt={Item:{id:"minecraft:target"}},distance=..3] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=2}] run kill @s
