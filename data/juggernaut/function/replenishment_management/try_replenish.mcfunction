...
execute if entity @s[tag=rogue] if entity @a[tag=juggernaut,distance=18..24,tag=!is_undetectable] run particle minecraft:witch ~ ~2.5 ~ 0.2 60 0.2 0 120 force @s
execute if entity @a[tag=juggernaut,distance=..18,tag=!is_undetectable] run particle minecraft:witch ~ ~2.5 ~ 0.2 60 0.2 0 120 force @s
