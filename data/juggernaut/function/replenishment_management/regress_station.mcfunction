...
execute if score #game_state var matches 11 run scoreboard players operation #regress_amount var = @n[type=armor_stand,tag=highest_station] replenish_amount
