...
execute if score #game_state var matches 10 run scoreboard players operation #regress_amount var = @n[type=armor_stand,tag=juggernaut_manager] replenish_progress
