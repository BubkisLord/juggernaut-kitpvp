...
execute at @n[type=armor_stand,tag=replenishment_tower,distance=..3] unless entity @e[type=armor_stand,tag=replenishment.station,distance=..3] run scoreboard players add @s replenishment_modifier 20
