...
execute as @e[type=armor_stand,tag=replenishment.station] at @s if score #game_state var matches 11 unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] unless entity @a[tag=juggernaut,limit=1,sort=nearest,distance=0..12] as @a[tag=runner,distance=..3,scores={replenish_debuff=1..,ticks_spent_debuffing=0},tag=!is_not_replenishing] run scoreboard players remove @n[type=armor_stand,tag=juggernaut_manager] replenish_progress 1
...
execute as @e[type=armor_stand,tag=replenishment.station] at @s if score #game_state var matches 11 unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] unless entity @a[tag=juggernaut,limit=1,sort=nearest,distance=0..12] as @a[tag=runner,distance=..3,scores={replenish_buff=1..,ticks_spent_buffing=0},tag=!is_not_replenishing] run scoreboard players add @n[type=armor_stand,tag=juggernaut_manager] replenish_progress 1
...
execute as @e[type=armor_stand,tag=replenishment.station] at @s if score #game_state var matches 11 unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] if entity @a[tag=juggernaut,limit=1,sort=nearest,distance=0..12] as @a[tag=runner,distance=..3,tag=using_unwavering_strength,tag=!is_not_replenishing] run scoreboard players add @n[type=armor_stand,tag=juggernaut_manager] replenish_progress 1
execute as @e[type=armor_stand,tag=replenishment.station] at @s if score #game_state var matches 11 unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] if entity @a[tag=juggernaut,limit=1,sort=nearest,distance=0..12] as @a[tag=runner,distance=..3,tag=using_unwavering_strength,tag=!is_not_replenishing] run scoreboard players add @n[type=armor_stand,tag=replenishment.station] replenish_amount 1
