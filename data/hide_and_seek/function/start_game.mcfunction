...
item replace entity @a[tag=seeker] hotbar.0 with netherite_sword[unbreakable={}]
item replace entity @a[tag=seeker] armor.head with netherite_helmet[unbreakable={}]
item replace entity @a[tag=seeker] armor.chest with netherite_chestplate[unbreakable={}]
item replace entity @a[tag=seeker] armor.legs with netherite_leggings[unbreakable={}]
item replace entity @a[tag=seeker] armor.feet with netherite_boots[unbreakable={}]
