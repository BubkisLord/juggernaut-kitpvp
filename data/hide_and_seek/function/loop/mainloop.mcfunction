...
execute if score #juggernaut_manager second_counter matches 40.. run execute as @a[tag=seeker] at @s run execute as @a[tag=hider] run function hide_and_seek:loop/seeker_radar
