...
scoreboard players add #juggernaut_manager second_counter 1
execute if score #juggernaut_manager second_counter matches 45.. run scoreboard players set #juggernaut_manager second_counter 0
