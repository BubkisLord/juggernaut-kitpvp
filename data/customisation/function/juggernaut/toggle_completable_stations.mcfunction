...
execute if score #juggernaut_customisation completable_stations matches 0 run setblock 2048 87 -8 waxed_copper_bulb[lit=false]
execute if score #juggernaut_customisation completable_stations matches 1 run setblock 2048 87 -8 waxed_copper_bulb[lit=true]
