...
execute if score #survival_customisation teams_mode matches 1 as @p[team=blue,scores={lives_remaining=1..}] run scoreboard players add #teams_alive var 1
execute if score #survival_customisation teams_mode matches 1 as @p[team=red,scores={lives_remaining=1..}] run scoreboard players add #teams_alive var 1
execute if score #survival_customisation teams_mode matches 1 as @p[team=green,scores={lives_remaining=1..}] run scoreboard players add #teams_alive var 1
execute if score #survival_customisation teams_mode matches 1 as @p[team=yellow,scores={lives_remaining=1..}] run scoreboard players add #teams_alive var 1

execute if score #survival_customisation teams_mode matches 1 if score #teams_alive var matches ..1 run scoreboard players set #survival_game_ending var 1
...
execute if score #teams_alive var matches ..1 if score #survival_customisation teams_mode matches 1 if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[team=blue,scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"text":"Blue","color":"blue","bold": true},{"text": " Has Won!","color": "white","bold": false}]
execute if score #teams_alive var matches ..1 if score #survival_customisation teams_mode matches 1 if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[team=red,scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"text":"Red","color":"red","bold": true},{"text": " Has Won!","color": "white","bold": false}]
execute if score #teams_alive var matches ..1 if score #survival_customisation teams_mode matches 1 if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[team=green,scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"text":"Green","color":"green","bold": true},{"text": " Has Won!","color": "white","bold": false}]
execute if score #teams_alive var matches ..1 if score #survival_customisation teams_mode matches 1 if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[team=yellow,scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"text":"Yellow","color":"yellow","bold": true},{"text": " Has Won!","color": "white","bold": false}]

execute if score #surv_players_alive var matches ..1 if score #survival_customisation teams_mode matches 0 if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[scores={lives_remaining=1..},gamemode=adventure] run tellraw @a [{"selector":"@s","color":"dark_aqua","bold": true},{"text": " Has Won!","color": "white","bold": false}]

# execute if score #survival_customisation teams_mode matches 1.. if score #survival_game_ending var matches 1 if score #end_game_timer var matches 10.. as @a[scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"nbt":"team", "entity": "@s","bold": true},{"text": " Has Won!","color": "white","bold": false}]
