...
item replace entity @s armor.legs with iron_leggings[item_name='{"text":"Steel Leggings","color":"dark_aqua","italic":false}',lore=['{"text":"Not very pretty, but very effective.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
tellraw @s {"text":" "}
