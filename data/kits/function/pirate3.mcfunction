...
give @s bow[item_name='{"text":"Old Wooden Bow","color":"dark_aqua","italic":false}',lore=['{"text":"Not worth a lot, sadly.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
give @s arrow[item_name='{"text":"Feathered Arrow","color":"dark_aqua","italic":false}',lore=['{"text":"Aiming is the key.","color":"dark_gray"}']] 128
item replace entity @s armor.head with leather_helmet[item_name='{"text":"Captain\'s Hat","color":"dark_aqua","italic":false}',lore=['{"text":"A cool hat for a cool pirate.","color":"dark_gray"}'],dyed_color=1907746,unbreakable={},hide_additional_tooltip={}]
tellraw @s {"text":" "}
