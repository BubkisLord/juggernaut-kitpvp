...
clear @s
tag @s add ambusher
give @s iron_sword[item_name={"text":"Steel Dagger","color":"dark_purple","italic":false},lore=[{"text":"Crafted by an expert blacksmith.","color":"dark_gray"}],unbreakable={}]
...
item replace entity @s armor.legs with leather_leggings[item_name={"text":"Ambusher's Pants","color":"dark_purple","italic":false},lore=[{"text":"Make sure you can see yourself!","color":"dark_gray"}],dyed_color=2168370,unbreakable={}]

item replace entity @s armor.feet with leather_boots[item_name={"text":"Ambusher's Shoes","color":"dark_purple","italic":false},lore=[{"text":"Unbelievably silent.","color":"dark_gray"}],dyed_color=2168370,unbreakable={}]
