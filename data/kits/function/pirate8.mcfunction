...
clear @s bow
clear @s arrow
give @s trident[item_name='{"text":"Speartooth Trident","color":"dark_aqua","italic":false}',lore=['{"text":"A true pirate\'s treasure.","color":"dark_gray"}'],unbreakable={},enchantments={loyalty:7},hide_additional_tooltip={}]
clear @s iron_sword
give @s iron_sword[item_name='{"text":"Maw of the Deep","color":"dark_blue","italic":true,"bold":true}',lore=['{"text":"Use to return to the sea.","color":"dark_gray"}'],unbreakable={},enchantments={sharpness:4},hide_additional_tooltip={}]
tellraw @s {"text":" "}
tellraw @s {"text":" "}
