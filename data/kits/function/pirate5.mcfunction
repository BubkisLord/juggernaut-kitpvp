...
clear @s stone_sword
give @s iron_sword[item_name='{"text":"Captain\'s Cutlass","color":"dark_aqua","italic":false}',lore=['{"text":"A mighty treasure.","color":"dark_gray"}'],unbreakable={},enchantments={sharpness:2},hide_additional_tooltip={}]
tellraw @s {"text":" "}
