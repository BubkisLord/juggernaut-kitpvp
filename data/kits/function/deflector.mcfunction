...
clear @s
tag @s add deflector
give @s blaze_rod[item_name='{"text":"Staff of Deflection","color":"dark_purple","italic":false}',lore=['{"text":"Takes a true master to wield.","color":"dark_gray"}'],attribute_modifiers=[{id:"minecraft:attack_speed",amount:-2.0,operation:"add_value",type:"attack_speed"}],hide_additional_tooltip={}]
