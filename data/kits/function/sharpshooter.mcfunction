...
give @s tipped_arrow[potion_contents="minecraft:luck",item_name={"text":"Lucky Arrow","color":"dark_aqua","italic":false},lore=[{"text":"Bow must be fully drawn.","color":"dark_gray"}]] 5
