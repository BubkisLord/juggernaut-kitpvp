...
clear @s
tag @s add unicorn
give @s iron_sword[item_name='{"text":"Dual-Edged Longsword","color":"gold","italic":false}',lore=['{"text":"Elegant, but razor-sharp.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
give @s cooked_beef[item_name='{"text":"Steak","color":"gold","italic":false}',lore=['{"text":"Eat to regenerate.","color":"dark_gray"}']] 16
item replace entity @s armor.head with end_rod[item_name='{"text":"Unicorn\'s Horn","color":"gold","italic":false}',lore=['{"text":"Sets the unicorn apart from horses.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
