...
give @s iron_sword[item_name='{"text":"Katana","color": "#aa00aa", "bold": true, "italic": true}',lore=['{"text": "Only wielded by the most disciplined and learned samurai.","color": "dark_gray"}'],enchantments={sharpness:3,sweeping_edge:8},unbreakable={},hide_additional_tooltip={},attribute_modifiers={modifiers:[{type:"attack_speed",id:"attack_speed",amount: -3.0, operation:"add_value"}]}]
