...
clear @s
tag @s add pirate
give @s stone_sword[item_name={"text":"Stone Cutlass","color":"dark_aqua","italic":false},lore=[{"text":"A pretty decent weapon.","color":"dark_gray"}],unbreakable={},enchantments={sharpness:1}]
