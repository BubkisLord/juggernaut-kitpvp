...
clear @s
tag @s add levitator
give @s iron_sword[item_name='{"text":"Steel Blade","color":"dark_purple","italic":false}',lore=['{"text":"Weighs surprisingly little.","color":"dark_gray"}'],unbreakable={},enchantments={sharpness:1},hide_additional_tooltip={}]
item replace entity @s hotbar.1 with firework_rocket[item_name='{"text":"Self-Levitate","color":"dark_purple","italic":false}',lore=['{"text":"Hold to fly upwards. Consumes rockets.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}] 25
item replace entity @s hotbar.2 with phantom_membrane[item_name='{"text":"Charm of Floatation","color":"dark_purple","italic":false}',lore=['{"text":"Stolen from a Divinity. Hold to fall slowly.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
item replace entity @s hotbar.3 with flower_banner_pattern[item_name='{"text":"Levitation Scroll","color":"dark_purple","italic":false}',lore=['{"text":"Drop to send everyone nearby flying.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
