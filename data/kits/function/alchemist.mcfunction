...
clear @s
tag @s add alchemist
give @s golden_sword[item_name='{"text":"Golden Blade","color":"dark_purple","italic":false}',lore=['{"text":"Used to be a stone sword.","color":"dark_gray"}'],enchantments={sharpness:2},unbreakable={},hide_additional_tooltip={}]
...
give @s splash_potion[item_name='{"text":"Vial of Mercury","color":"dark_purple","italic":false}',lore=['{"text":"Inflict harm upon your enemies.","color":"dark_gray"}'],potion_contents={custom_effects:[{Id:7,Amplifier:1}],custom_color:10930638},hide_additional_tooltip={}]

give @s splash_potion[item_name='{"text":"Vial of Mercury","color":"dark_purple","italic":false}',lore=['{"text":"Careful with that stuff; it\'s toxic!","color":"dark_gray"}'],potion_contents={custom_effects:[{Id:7,Amplifier:1}],custom_color:10930638},hide_additional_tooltip={}]
