...
clear @s
tag @s add farmer
give @s iron_hoe[item_name='{"text":"Steel Hoe","color":"dark_green","italic":false}',lore=['{"text":"The sharpest tool in the shed.","color":"dark_gray"}'],unbreakable={},enchantments={sharpness:2},hide_additional_tooltip={}]
give @s cooked_beef[item_name='{"text":"Steak","color":"dark_green","italic":false}',lore=['{"text":"Eat to regenerate.","color":"dark_gray"}']]
item replace entity @s armor.head with leather_helmet[item_name='{"text":"Straw Hat","color":"dark_green","italic":false}',lore=['{"text":"Stereotypical? You think?","color":"dark_gray"}'],dyed_color=13874947,unbreakable={},hide_additional_tooltip={}]
