...
clear @s bow
give @s bow[item_name='{"text":"Runic Bow","color":"dark_aqua","italic":false}',lore=['{"text":"An extremely valuable treasure.","color":"dark_gray"}'],unbreakable={},enchantments={power:1,punch:1},hide_additional_tooltip={}]
tellraw @s {"text":" "}
