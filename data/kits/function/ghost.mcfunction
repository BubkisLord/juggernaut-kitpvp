...
give @s diamond_sword[item_name='{"text":"Diamond Blade","color":"dark_purple","italic":false}',lore=['{"text":"Dual-edged and razor sharp.","color":"dark_gray"}'],unbreakable={},hide_additional_tooltip={}]
