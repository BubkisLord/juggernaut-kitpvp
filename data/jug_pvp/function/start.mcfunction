...
scoreboard players operation #max_crate_count var = #jug_pvp_customisation crate_count
...
scoreboard players operation #jug_pvp_teams var = #jug_pvp_customisation teams_mode
execute if score #jug_pvp_teams var matches 0 run scoreboard players set #game_state var 40
execute if score #jug_pvp_teams var matches 1 run scoreboard players set #game_state var 45
execute if score #jug_pvp_teams var matches 1 run function survival:start_with_teams
...
scoreboard players set #jug_pvp_setup_worldborder var 0

# Remove any leftover items
kill @e[type=item]

# Reset - no longer needed.
scoreboard players set #jug_pvp_teams var 0
