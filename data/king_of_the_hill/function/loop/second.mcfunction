...
# execute if score #king_of_the_hill_teams var matches 1.. if score #surv_players_alive var = #1 var if score #end_game_timer var >= #15 var as @a[scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"nbt":"team", "entity": "@s","bold": true},{"text": " Has Won!","color": "white","bold": false}]
