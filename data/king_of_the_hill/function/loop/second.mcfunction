...
execute if score #teams_alive var matches ..1 if score #game_state var matches 36 if score #king_of_the_hill_game_ending var matches 1 if score #end_game_timer var matches 10.. as @p[team=yellow,scores={lives_remaining=1..}] run tellraw @a [{"text": "Team ","color": "white","bold": false},{"text":"Yellow","color":"yellow","bold": true},{"text": " Has Won!","color": "white","bold": false}]
