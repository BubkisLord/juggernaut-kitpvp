...
# Spawn Crates
execute if score #crate_count var < #max_crate_count var run summon armor_stand 0 100 0 {Tags:["crate","kill_on_end_game"],Invisible:true,Invulnerable:true,Small:true,NoGravity:true,CustomName:{"text": "King of the Hill Crate","bold": true},CustomNameVisible:true}
