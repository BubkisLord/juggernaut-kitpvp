...
execute if score #king_of_the_hill_teams var matches 0 run scoreboard players set #game_state var 30
execute if score #king_of_the_hill_teams var matches 1 run scoreboard players set #game_state var 35
...
# Start the game
execute if score #king_of_the_hill_teams var matches 0 run scoreboard players set #game_state var 31
execute if score #king_of_the_hill_teams var matches 1 run scoreboard players set #game_state var 36
