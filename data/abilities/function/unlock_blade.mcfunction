...
give @s diamond_sword[item_name={"text":"Ancient Blade","color":"dark_green","italic":false},lore=[{"text":"Just about to break.","color":"dark_gray"}],damage=1560,enchantments={sharpness:255}]
