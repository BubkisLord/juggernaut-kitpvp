...
give @s iron_sword[item_name='{"text":"Maw of the Deep","color":"dark_aqua","italic":false,"bold":false}',lore=['{"text":"A great weapon with all power lost to the sea...","color":"dark_gray"}'],unbreakable={},enchantments={sharpness:4},hide_additional_tooltip={}]