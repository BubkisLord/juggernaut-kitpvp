...
execute if score #end_game_timer var < #0 var run function juggernaut_pvp:end_game
...
execute if entity @a[tag=hunter] run function juggernaut:loop/kits_loop/hunter
...
execute as @e[type=armor_stand,tag=surv_game_manager,scores={tick_counter=20..}] run function juggernaut_pvp:loop/second
