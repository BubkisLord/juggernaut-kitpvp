team join duelist @s
tellraw @a {"text":" "}
tellraw @a [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"selector":"@s"},{"text":" just ranked up to ","color":"yellow","bold":false},{"text":"Duelist","color":"green","bold":false},{"text":"!","color":"yellow","bold":false}]
tellraw @a {"text":" "}
