...
tellraw @a {"text":" "}
tellraw @a [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"selector":"@s"},{"text":" finally reached the ","color":"yellow","bold":false},{"text":"Champion","color":"dark_aqua","bold":false},{"text":" rank!","color":"yellow","bold":false}]
tellraw @a {"text":" "}
