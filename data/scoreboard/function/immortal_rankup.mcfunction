...
tellraw @a {"text":" "}
tellraw @a [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"selector":"@s"},{"text":" has reached the ","color":"yellow","bold":false},{"text":"Immortal","color":"dark_red","bold":false},{"text":" rank! Now that's impressive!","color":"yellow","bold":false}]
tellraw @a {"text":" "}
