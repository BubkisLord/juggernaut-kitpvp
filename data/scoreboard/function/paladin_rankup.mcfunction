team join paladin @s
tellraw @a {"text":" "}
tellraw @a [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"selector":"@s"},{"text":" ranked up to ","color":"yellow","bold":false},{"text":"Paladin","color":"blue","bold":false},{"text":". Two ranks to go!","color":"yellow","bold":false}]
tellraw @a {"text":" "}
