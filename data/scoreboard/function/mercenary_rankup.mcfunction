...
tellraw @a {"text":" "}
tellraw @a [{"text":"[","color":"dark_gray","bold":true},{"text":"KitPvP","color":"gold","bold":true},{"text":"] ","color":"dark_gray","bold":true},{"selector":"@s"},{"text":" is now a ","color":"yellow","bold":false},{"text":"Mercenary","color":"dark_green","bold":false},{"text":"! Not bad.","color":"yellow","bold":false}]
tellraw @a {"text":" "}
