...
item replace entity @a[tag=lobby.player] armor.head with stone_button[enchantments={binding_curse:1},attribute_modifiers=[{type:"minecraft:generic.knockback_resistance",slot:"head",amount:1,operation:"add_value", id:"minecraft:generic.attack_damage"}],hide_additional_tooltip={}] 1
