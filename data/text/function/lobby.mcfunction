...
item replace entity @a[tag=lobby.player] armor.head with stone_button[enchantments={binding_curse:1},attribute_modifiers=[{type:"minecraft:knockback_resistance",slot:"head",amount:1,operation:"add_value", id:"minecraft:attack_damage"}],hide_additional_tooltip={}] 1
