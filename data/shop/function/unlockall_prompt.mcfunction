...
tellraw @s [{"text":"[","bold":true,"color":"dark_gray"},{"text":"KitPvP","bold":true,"color":"gold"},{"text":"] ","bold":true,"color":"dark_gray"},{"text":"[Confirm]","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/trigger unlockall set 2"}},{"text":" "},{"text":"[Cancel]","bold":true,"color":"dark_red","clickEvent":{"action":"run_command","value":"/trigger unlockall set 3"}},{"text":"\n"}]
