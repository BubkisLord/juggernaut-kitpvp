#Sound and particles
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] run execute as @e[tag=replenishment.station] at @s if entity @a[limit=1,sort=nearest,distance=0..16] run particle minecraft:totem_of_undying ~ ~2.5 ~ 0.2 1 0.2 0 2 force @a[distance=0..25]
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] run execute as @e[tag=replenishment.station] at @s if entity @a[limit=1,sort=nearest,distance=0..16] run particle minecraft:portal ~ ~2 ~ 0 1 0 0 1 force @a[distance=0..25]
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] if entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] run execute as @e[tag=replenishment.station] at @s if entity @a[limit=1,sort=nearest,distance=0..16] run scoreboard players add @s aura_sound 1
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] as @e[scores={aura_sound=20..},tag=replenishment.station] run function abilities:aura_sound
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] as @e[tag=replenishment.station] at @s if entity @a[limit=1,sort=nearest,distance=0..16] run scoreboard players add @s aura_sound 1
...
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] run execute as @e[tag=replenishment.station_emitter] at @s run particle minecraft:totem_of_undying ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=runner]

# Display a blocked replenishment station to the juggernauts.
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] run execute as @e[tag=replenishment.station_emitter] at @s run particle minecraft:totem_of_undying ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=juggernaut]
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] run execute as @e[tag=replenishment.station_emitter] at @s run particle minecraft:white_smoke ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=juggernaut]

execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] unless entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] run execute as @e[tag=replenishment.station_emitter] at @s run particle minecraft:totem_of_undying ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=spectator]
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] if entity @e[type=armor_stand,tag=banishment_glyph,distance=..32] run execute as @e[tag=replenishment.station_emitter] at @s run particle minecraft:white_smoke ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=spectator]
...
execute unless entity @e[type=armor_stand,tag=juggernaut_manager,scores={game_state=0}] run execute as @e[tag=replenishment.station] at @s if entity @a[tag=juggernaut,limit=1,sort=nearest,distance=0..24] if entity @s[scores={replenish_timeout=1..}] run particle minecraft:witch ~ ~2.5 ~ 0.2 60 0.2 0 120 force @a[tag=spectator]
...
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] at @e[tag=replenishment.station] as @a[distance=..1,scores={seconds=..0}] run function other:replenish
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run execute at @e[tag=replenishment.station,nbt={Small:1b}] as @a[distance=..8] run title @s[scores={seconds=1..}] actionbar [{"text":"Replenishment: ","color":"yellow","bold":false},{"score":{"name":"*","objective":"seconds"},"color":"red","bold":false}]
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run execute at @e[tag=replenishment.station,nbt={Small:1b}] as @a[distance=..8] run title @s[scores={seconds=..0}] actionbar [{"text":"Replenishment: ","color":"yellow","bold":false},{"text":"Ready","color":"green","bold":false}]

#Tutorial stations
execute unless entity @n[type=armor_stand,tag=surv_game_manager,scores={game_state=1}] unless entity @n[type=armor_stand,tag=juggernaut_manager,scores={game_state=1}] run execute at @e[tag=replenishment.station,nbt={Small:0b}] as @a[distance=..8] run title @s actionbar [{"text":"Replenishment: ","color":"yellow","bold":false},{"text":"Ready","color":"green","bold":false}]